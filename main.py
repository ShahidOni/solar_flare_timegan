...
# 2. Data Loading
from data_loading import google_data_loading, sine_data_generation, load_solar_data
...
if data_name == 'solar':
    dataX = load_solar_data(classLabel=0)
elif data_name == 'sine':
    No = 10000
    F_No = 5
...
parameters['output_dir'] = "C:\\Codes\\timegan\\result0\\"
