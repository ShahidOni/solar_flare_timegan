...
def PCA_Analysis (dataX, dataX_hat, parameters):
    ...
    plt.xlabel('x-pca')
    plt.ylabel('y_pca')
    plt.savefig(parameters['output_dir'] + "pca.png")
    
    
#%% TSNE Analysis
    
def tSNE_Analysis (dataX, dataX_hat, parameters):
    ...
    plt.xlabel('x-tsne')
    plt.ylabel('y_tsne')
    plt.savefig(parameters['output_dir'] + "tsne.png")
